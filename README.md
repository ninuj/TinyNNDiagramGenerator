...
[![Live on Render](https://img.shields.io/badge/Live%20on-Render-6c6cff?style=flat-square&logo=render)](https://tinynndiagramgenerator.onrender.com)
...
🔹 Built with **FastAPI**  
🔹 Visuals rendered using **Matplotlib**  
🔹 Self-hostable or live on **Render**  
🔹 Useful for educators, students, and ML beginners
...
![Tiny NN Example](static/example_diagram.svg)
...
|--------|---------------------|--------------------------------------|
| POST   | `/generate-diagram` | Generate SVG of neural network       |
| GET    | `/`                 | See example output + link to docs    |
| GET    | `/docs`             | Swagger UI (try it online)           |


## 🔍 API Reference

-  Try it live: [Swagger UI](https://tinynndiagramgenerator.onrender.com/docs)
...
- Click on try it out
- Modify the json as you like with your layersizes and colors
    {
    "layer_sizes": [4, 6, 3],
